...
class StoreTextTheme{
  ...
  // light mode text themes
  static TextTheme lightTextTheme = TextTheme(
    headlineLarge: TextStyle().copyWith(fontSize: 37, fontWeight: FontWeight.bold, color: Colors.black),
  ...
  static TextTheme darkTextTheme = TextTheme(
    headlineLarge: TextStyle().copyWith(fontSize: 37, fontWeight: FontWeight.bold, color: Colors.white),
